...
?>
    ...
    <div class="page-wrapper">
      ...
      <div class="body-wrapper">
        <div class="container-fluid" style="text-align: center; padding: 50px; background-color: #f8f9fa;">
          <h1 style="font-size: 36px; color: #6c757d; font-weight: bold;">Coming Soon</h1>
          <p style="font-size: 18px; color: #6c757d;">We are working hard to bring you this feature. Stay tuned!</p>
        </div>
      </div>
      <?php 
